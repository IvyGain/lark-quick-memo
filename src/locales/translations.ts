...
export const translations = {
  ja: {
    ...
    recommendation: '初回利用の場合は「ガイド付きセットアップ」を選択してください。詳細な手順でスムーズに設定できます。',
    setupLater: '後で設定する',
    ...
    receiverHint: 'ヒント: Larkアプリでプロフィール → アカウント設定から正確なメールアドレスを確認できます。',
  ...
  en: {
    ...
    recommendation: 'For first-time users, we recommend selecting "Guided Setup" for smooth configuration with detailed instructions.',
    ...
    step2Details: [
      'Go to "Add features and capabilities" tab',
      'Select and enable "Bot"'
    ],
